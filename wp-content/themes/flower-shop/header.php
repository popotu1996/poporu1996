...
<?php flower_shop_get_header_search_form($cmsmasters_option); ?>

<!-- Start Page -->
<div id="page" class="<?php flower_shop_get_page_classes($cmsmasters_option); ?>hfeed site">
...
<header id="header"<?php 
	if ($cmsmasters_option['flower-shop' . '_header_styles'] == 'fullwidth') {
...
<div id="middle">
<?php 
flower_shop_page_heading();


list($cmsmasters_layout, $cmsmasters_page_scheme) = flower_shop_theme_page_layout_scheme();
